...
class Point(object):
    ...
    def get_distance_from_start(self):
        original_point = Point(self.original_x, self.original_y)
        return self.get_distance_from(original_point)

    def closer_to(self, p2, p3):
        # Find distances

        dp2 = self.get_distance_from(p2)
        dp3 = self.get_distance_from(p3)
    ...
    def halfway_to(self, p2):
        ...
        # half the distance for x and y coordinates
